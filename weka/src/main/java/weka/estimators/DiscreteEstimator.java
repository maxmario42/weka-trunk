...
public class DiscreteEstimator extends Estimator implements
    ...
    /**
     * No-arg constructor needed to make WEKA's forName() work. Uses one symbol
     * and Laplace value of 1.
     */
     ...
     *
     * @param argv should contain a sequence of integers which will be treated
     * as symbolic.
     */
